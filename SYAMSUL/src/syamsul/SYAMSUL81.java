...
public class SYAMSUL81
{
    ...
    public static void main (String[] args)
    {
        ...
        do
        {
            ...
            switch (pil ){
                case "1" : {
                    pr = JOptionPane.showInputDialog(null,"DAFTAR HARGA PER PORSI 50.00"
                ...
                case "2" : {
                    pr = JOptionPane.showInputDialog(null,"DAFTAR HARGA PER PORSI 75.00"
                ...
                case "3" : {
                    pr = JOptionPane.showInputDialog(null,"DAFTAR HARGA PER PORSI 125.00"
